...
IF(YEAR(m.`FechaFin`)<2018,nota_final(a.nota,a.asistencia,a.practicas),(IF(IFNULL((select count(*) from `respuestassatisfaccion` r where r.`IdModulo`=a.IdModulo and r.`CiAlumno`=a.`CiAlumno` ),0)>0
, nota_final(a.nota,a.asistencia,a.practicas),'No ha llenado la encuesta de satisfacción'))) as notaf  
