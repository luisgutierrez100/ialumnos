...
set a.`Nota`=$examen,a.`Asistencia`=$asistencia,
a.`Practicas`=$practicas,a.`FechaRegistroNota`=now()
...
require_once('../../../PHPMailer/PHPMailer/class.smtp.php');
...
<span>Estimad@ Coordinador@ las notas del grupo '.$_POST['grupo'].' de: </span><br><br>
<span>'.($_POST['especialista']).' </span><br><br>
<span>Módulo: '.($_POST['tema']).' </span><br><br>
<span>Regional: '.($_POST['regional']).' </span><br><br>
Ya se encuentran disponibles en el sistema, haga click en el siguiente botón para enviar correo a los alumnos:<br><br>
<a href="http://ibnored.ibnorca.org/ialumno/gestion/NotasD/envioalumnos.php?a1='.$_POST['grupo'].'&a2='.$_POST['especialista'].'&a3='.$_POST['tema'].'&a4='.$_POST['mod'].'"><img src="http://ibnored.ibnorca.org/itranet/images/ENVIAR.jpg" width="280" height="154" alt="Enviar"></a> <br><br>
...
$enviado[$n] = $cor->enviarCorreo('info@ibnorca.org', '1nf01bn019', 'IBNORED',$correocor,$coordinadora, 'NOTAS IBNORCA', $mm);
$cor=null;
