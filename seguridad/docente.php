...
if (isset($_POST['ci'])) {
  ...
  $LoginRS__query=sprintf("SELECT CiDocente, Password, Email FROM docente WHERE CiDocente=%s AND Password=%s",
...
<div class="login">
  ...
  <div class="login-form">
    ...
    <label for="ci"> </label>
    <input type="text" id="ci" name="ci" placeholder="6089959"/><br>
    <h3>Correo:</h3>
    <label for="correo"> </label>
    <input type="text" id="correo" placeholder="gonzalo.romero@ibnorca.org" name="correo"/>
    <br>
    <h3>Password:</h3>
