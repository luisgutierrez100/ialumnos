...
n_docente(m.CiDocente) as docente,m.CiDocente as cidocente,
 `d_clasificador`(p.IdGestion) as gestion,`d_clasificador`(m.`IdTema`) as modulo
   ...
   where m.`CiDocente`=".$ci." and (p.IdGestion=124 or p.IdGestion=1204)";
...
?>
              ...
              <tr>
                ...
                <td class="ui-front"><?php echo utf8_encode($docente); ?></td>
                  <td ><a href="./redireccionamiento_rec.php?cialumno=<?php echo $ci; ?>&mod=<?php echo $idmodulo; ?>" title="Ingresar Notas"/><center><span style ="font-size:20px;color:#404654;"  class="glyphicon glyphicon-edit"></span></center></a></td>
