...
?>
              ...
              <tr>
                ...
                <td class="ui-front"><?php echo html_entity_decode($docente); ?></td>
                  <td ><a href="./Lista_Notas.php?cialumno=<?php echo $ci; ?>&a=<?php echo $idmodulo; ?>" title="Ingresar Notas"/><center><span style ="font-size:20px;color:#404654;"  class="glyphicon glyphicon-edit"></span></center></a></td>
