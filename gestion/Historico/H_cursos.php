     ...
     <table  id="clasificador" class="table table-striped table-bordered" height="80%" width="100%" border="0" cellspacing="0" cellpadding="0">
             <thead>
              <tr>
                ...
                <th width="10%" style="width: 50px;">Acta de Notas</th>
               </tr>
            </thead>
            <tbody>
               <?php
...
?>
              ...
              <tr>
                ...
                <td class="ui-front"><?php echo utf8_encode($docente); ?></td>
                  <td ><a href="../NotasD/Lista_notas.php?cialumno=<?php echo $ci; ?>&a=<?php echo $idmodulo; ?>" title="Ingresar Notas"/><center><span style ="font-size:20px;color:#404654;"  class="glyphicon glyphicon-edit"></span></center></a></td>
