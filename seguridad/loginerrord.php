...
if (isset($_POST['ci'])) {
  ...
  $MM_redirectLoginFailed = "login.php?a=D";
  $MM_redirecttoReferrer = false;
  mysqli_select_db($database_conecta, $conecta);
  
  $LoginRS__query=sprintf("SELECT CiDocente, Password FROM alumnos WHERE CiDocente=%s AND Password=%s",
...
<table width="60%" border="0" align="center" cellpadding="2" cellspacing="1">
       ...
       <tr> <td align="center"><a href="login.php?a=D"><input type="submit" name="button" id="button" value="..:: Volver a Intentar ::.."></a></td></tr>
       </table>
