...
mysqli_query($conn,"UPDATE alumnos
SET Nombre='$nombre', ApPaterno='$paterno', ApMaterno='$materno', FechaNacimiento='$fnacimiento', IdProfesion=$profesion, IdCiudadResidencia='$idcresidencia',FonoDomicilio='$td',FonoCelu='$cel',Email='$email',NombreEmpresa='$ne',CargoEmpresa='$ce',FonoEmpresa='$to',PaginaWebEmpresa='$pw', RazonSocial='$rz', Nit='$nit' WHERE CiAlumno=$ci") or die("Los datos No se actualizaron");
