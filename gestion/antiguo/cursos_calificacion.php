     ...
     <table  id="clasificador" class="table table-striped table-bordered" height="80%" width="100%" border="0" cellspacing="0" cellpadding="0">
             <thead>
              <tr>
                ...
                <th width="10%" style="width: 50px;">Calificar</th>
               </tr>
            </thead>
            <tbody>
               <?php
...
?>
              ...
              <tr>
                ...
                <td ><a href="./form_evaluacion.php?cialumno=<?php echo $ci; ?>&idmod=<?php echo $mod; ?>&idcur=<?php echo $idc; ?>" title="Calificar Docente"/><center><span style ="font-size:20px;color:#404654;"  class="glyphicon glyphicon-edit"></span></center></a></td>
               </tr> 
