...
$consulta1 = "select CiDocente,Nombre,ApPaterno,ApMaterno from docente
				where CiDocente=".$ci;
...
?>
<table align="center" width="778" border="0">
  <tr>
    <td width="0"><h5 align="justify"><font color="#FF0000">*Estimado Docente, los formularios de notas deben ser llenados como fecha límite 15 días (Calendario) después de la fecha de conclusión del curso. El sistema automáticamente deshabilitará el formulario de notas una vez concluido el plazo.</font></h5></td>
  </tr>
</table>
...
n_docente(m.CiDocente) as docente,m.CiDocente as cidocente,
 `d_clasificador`(p.IdGestion) as gestion,`d_clasificador`(m.`IdTema`) as modulo
   ...
   where m.`CiDocente`=".$ci." and (p.IdGestion=124 or p.IdGestion=1204 or p.IdGestion=123)";
...
?>
              ...
              <tr>
                ...
                <td class="ui-front"><?php echo utf8_encode($docente); ?></td>
                  <td ><a href="./redireccionamiento.php?cialumno=<?php echo $ci; ?>&mod=<?php echo $idmodulo; ?>" title="Ingresar Notas"/><center><span style ="font-size:20px;color:#404654;"  class="glyphicon glyphicon-edit"></span></center></a></td>
