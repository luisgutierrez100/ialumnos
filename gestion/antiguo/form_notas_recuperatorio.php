...
<th width="20%">
 ...
 <th > <input align="middle" type="number" min="1" max="71" class="form-control" name="recuperatorio<?php echo $n; ?>" id="recuperatorio<?php echo $n; ?>" value="" onkeyup="sumar();" onKeyPress="return valida(event);"   /> 
 </th>
