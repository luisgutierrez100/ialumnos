...
<span>Estimad@ Estudiante las notas del grupo '.$_POST['a1'].' de: </span><br><br>
...
$cor = new Correo();
$enviado[$n] = $cor->enviarCorreo('info@ibnorca.org', '1nf01bn019', 'IBNORED',$email, $nombre, 'NOTAS IBNORCA', $mm); 
$cor=null;
